...
public class Discharged implements Serializable {
    ...
    public Discharged(String patient_national_id) {
    ...
    public Discharged(Integer id, String patient_national_id, String inpatient_name, String date_of_birth, String inpatient_sickness, String inpatient_amount_paid, String inpatient_phone_number, Date inpatient_date_in) {
        this.id = id;
        this.patient_national_id = patient_national_id;
