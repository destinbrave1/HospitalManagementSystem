...
public class Transfered implements Serializable {
    ...
    public Transfered(String patient_national_id) {
        this.patient_national_id = patient_national_id;
    }

    public Transfered(Integer id, String patient_national_id, String inpatient_name, String date_of_birth, String inpatient_sickness, String inpatient_amount_paid, Department department, Rooms room, String inpatient_phone_number) {
        this.id = id;
        this.patient_national_id = patient_national_id;
